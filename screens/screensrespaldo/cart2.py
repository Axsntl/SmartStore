...
def CartView(page: ft.Page):
    ...
    def rebuild():
        ...
        if not carrito:
                                    ...
                                    ft.Row(
                                        ...
                                        controls=[
                                            ...
                                            ft.IconButton(icon=ft.icons.DELETE, tooltip="Eliminar",
                                                           on_click=lambda e, pid=item["id"]: (eliminar_producto(pid), rebuild(), page.update())
                                            )
                                        ]
                                    ),
                                    ft.Row(
                                        ...
                                        controls=[
                                            ...
                                            ft.Column(
                                                ...
                                                controls=[
                                                    ...
                                                    ft.Row(spacing=10, controls=[ft.Text("Cantidad:"), input_cantidad]),
            ...
            contenedor.controls.append(ft.Row(alignment=ft.MainAxisAlignment.CENTER, controls=[toggle_ticket]))
            contenedor.controls.append(
                ft.Row(
    ...
    # Handler de compra
    def handle_buy(e):
        # Primero generar ticket si corresponde
        if toggle_ticket.value:
            if usuario_actual:
                ...
                return
        # Luego mensaje de confirmación
        mostrar_snackbar(page, "Compra realizada" + (" y ticket generado" if toggle_ticket.value else ""))
        vaciar_carrito()
        rebuild()
        page.update()
        time.sleep(2)
